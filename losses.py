...
def loss_unl(net, imgs_tu_w, imgs_tu_s, fu1, outputs_u11, f3, outputs_u3, proto_t, args,batch_idx):
    #feat_tu_con, logits_tu = net(torch.cat((imgs_tu_w, imgs_tu_s), dim=0),return_features=True)
    #feat_tu_w, feat_tu_s = feat_tu_con.chunk(2)
    #logits_tu_w, logits_tu_s = logits_tu.chunk(2)
    feat_tu_w = fu1
    feat_tu_s = f3
    logits_tu_w = outputs_u11
    logits_tu_s = outputs_u3
    ...
    L_intra, pseudo_label_ot, score_ot = ot_loss(proto_t, feat_tu_w, feat_tu_s, args)
    ...
    return L_intra, unl_mask, unl_pseudo_label, score_ot, feat_tu_w
...
def ot_loss(proto_t, feat_tu_w, feat_tu_s, args):
    ...
    Lm = center_loss_cls(proto_t.mo_pro, feat_tu_s, pred_ot, num_classes=args.num_class)
...
def center_loss_cls(centers, x, labels, num_classes=10):
...
class Prototype_t:
    def __init__(self, C=10, dim=512, m=0.9):
